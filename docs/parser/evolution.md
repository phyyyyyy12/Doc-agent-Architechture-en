...
#### **v3.0 - 动态 Token 窗口管理 (Current)** `2024-06-15`
...
**这样的结构是否与你的 Parser 模块完全同步了？如果需要，我可以为你把两份内容合并成一个适合 GitHub 首页的 `CHANGELOG` 视图。**
